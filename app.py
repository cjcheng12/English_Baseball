...
initial_word_data = [
    ...
    {"word": "Pitcher", "def": "投手", "ex": "The ___ threw a fastball at 100 mph."},
    {"word": "Catcher", "def": "捕手", "ex": "The ___ caught the ball behind home plate."},
    {"word": "Umpire", "def": "裁判", "ex": "The ___ shouted, 'Strike!'"}, 
    {"word": "Inning", "def": "局（比賽的）", "ex": "They scored three runs in the first ___."},
    {"word": "Dugout", "def": "球員休息區", "ex": "The players waited in the ___."},
    ...
    {"word": "Infielder", "def": "內野手", "ex": "The ___ fielded the ground ball cleanly."},
    {"word": "Outfielder", "def": "外野手", "ex": "The ___ caught it near the wall."},
    {"word": "Mound", "def": "投手丘", "ex": "The pitcher stepped onto the ___."},
    {"word": "Batter", "def": "打擊者", "ex": "The ___ waited for a fastball."},
    ...
    {"word": "First Base", "def": "一壘", "ex": "He stretched to catch the throw at ___."},
    {"word": "Second Base", "def": "二壘", "ex": "The runner slid into ___."},
    {"word": "Third Base", "def": "三壘", "ex": "He rounded ___ and headed home."},
    {"word": "Home Plate", "def": "本壘", "ex": "The runner touched ___ to score."},
    {"word": "Batting Average", "def": "打擊率", "ex": "His ___ improved this month."},
    {"word": "ERA", "def": "防禦率", "ex": "The pitcher lowered his ___."},
    {"word": "Bullpen Catcher", "def": "牛棚捕手", "ex": "The ___ helped warm up pitchers."},
